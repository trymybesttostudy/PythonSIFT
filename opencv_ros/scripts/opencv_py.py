...
def callback(data):
    ...
    cv_img = cv_img[200:2160, 538:3840-380]
    ...
    des_red = ColorFindContours(srcImage,
                                ...
                                (int)(255 * 0.44), (int)(255 * 0.72),  # 饱和度最小值~最大值
                                (int)(255 * 0.31), (int)(255 * 0.61))  # 亮度最小值~最大值
    ...
    des_purple = ColorFindContours(srcImage,
                                   262 / 2, 289 / 2,  # 色调最小值~最大值
                                   (int)(255 * 0.14), (int)(255 * 0.40),  # 饱和度最小值~最大值
                                   (int)(255 * 0.34), (int)(255 * 0.53))  # 亮度最小值~最大值
    des_purple = Dilate(des_purple)
    "--------------- 黄色L型左方块--------------- "
    des_yellow = ColorFindContours(srcImage,
                                   49 / 2, 60 / 2,  # 色调最小值~最大值
                                   (int)(255 * 0.41), (int)(255 * 0.78),  # 饱和度最小值~最大值
                                   (int)(255 * 0.27), (int)(255 * 0.61))  # 亮度最小值~最大值
    des_yellow = Dilate(des_yellow)
    des_yellow = Dilate(des_yellow)

    "--------------- 蓝色Z型左方块--------------- "
    des_blue = ColorFindContours(srcImage,
                                 200 / 2, 235 / 2,  # 色调最小值~最大值
                                 (int)(255 * 0.20), (int)(255 * 0.48),  # 饱和度最小值~最大值
                                 (int)(255 * 0.16), (int)(255 * 0.46))  # 亮度最小值~最大值
    des_blue = Erode(des_blue)
    des_blue = Dilate(des_blue)
    
    #cv2.namedWindow('cv_img',0)
    #cv2.imshow("cv_img",des_blue)
    #cv2.waitKey(0)
    "--------------- 绿色Z型右方块--------------- "
    des_green = ColorFindContours(srcImage,
                                  100 / 2, 165 / 2,  # 色调最小值~最大值
                                  (int)(255 * 0.12), (int)(255 * 0.40),  # 饱和度最小值~最大值
                                  (int)(255 * 0.15), (int)(255 * 0.38))  # 亮度最小值~最大值
    ...
    des_orange = ColorFindContours(srcImage,
                                   0 / 2, 15 / 2,  # 色调最小值~最大值
                                   (int)(255 * 0.50), (int)(255 * 0.90),  # 饱和度最小值~最大值
                                   (int)(255 * 0.30), (int)(255 * 0.65))  # 亮度最小值~最大值
    des_orange = Erode(des_orange)
    ...
    des_brown = ColorFindContours(srcImage,
                                  0 / 2, 30 / 2,  # 色调最小值~最大值
                                  (int)(255 * 0.17), (int)(255 * 0.50),  # 饱和度最小值~最大值
                                  (int)(255 * 0.15), (int)(255 * 0.45))  # 亮度最小值~最大值
...
if __name__ == '__main__':
    ...
    # 实例化发布者对象
    pub_red_p = rospy.Publisher("red",Float64MultiArray, queue_size=0)
    pub_brown_p = rospy.Publisher("brown",Float64MultiArray, queue_size=0)
    pub_orange_p = rospy.Publisher("orange",Float64MultiArray, queue_size=0)
    pub_blue_p = rospy.Publisher("blue",Float64MultiArray, queue_size=0)
    pub_green_p = rospy.Publisher("green",Float64MultiArray, queue_size=0)
    pub_purple_p = rospy.Publisher("purple",Float64MultiArray, queue_size=0)
    pub_yellow_p = rospy.Publisher("yellow",Float64MultiArray, queue_size=0)
    # 创建消息对象
